...
$skillRepos = @(
    ...
    @{
        ...
        dest = "$ocSkillsDir\project-architect-skills"
    },
    @{
        ...
        dest = "$ocSkillsDir\the-architect-skills"
    },
    @{
        ...
        dest = "$ocSkillsDir\mattpocock-skills"
    },
    @{
        ...
        dest = "$ocSkillsDir\karpathy-skills-repo"
    },
    @{
    ...
    @{
        ...
        dest = "$ocSkillsDir\prompt-improver-skill-repo"
    },
    @{
...
# write the wrapper so OpenCode's skill discovery (and build_index.py) can find it.
$architectSkillMd = "$ocSkillsDir\the-architect-skills\SKILL.md"
if ((Test-Path "$ocSkillsDir\the-architect-skills") -and -not (Test-Path $architectSkillMd)) {
